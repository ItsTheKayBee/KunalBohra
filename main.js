...
function scroll(dy) {
	if (andy && RESOURCES_LOADED && screen.orientation.type != "portrait-primary" && screen.orientation.type != "portrait-secondary") {
...
function loadModel(path, pos, rot, s) {
